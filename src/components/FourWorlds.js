...
export default function FourWorlds() {
  return (
    <section id="four-worlds" className="relative bg-black text-white" style={{ height: "100vh" }}>
      <div className="flex h-full flex-col md:flex-row">
        ...
        {/* Text half */}
        <div className="flex w-full flex-1 flex-col justify-center px-[8%] py-16 md:w-1/2">
          <div className="max-w-[440px]">
            ...
            />
            <h2
              className="mb-8 text-[56px] uppercase leading-[0.85] text-white"
